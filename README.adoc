...
Toto je RC verze zadání. Případné opravy chyb v zadání budou opatřeny erratou a oznámeny studentům e-mailem.
...
Pokud máte jakékoliv dotazy, či naleznete chyby, napište je prosím do [Issues](https://github.com/3DprintFIT/B181CW-Assignment/issues) v tomto repozitáři.
